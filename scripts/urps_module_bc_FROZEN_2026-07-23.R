...
N_COHORT <- 1339L  # ssot-ok: FROZEN archival reproduction (2025 roster_snapshot). Live paths source mufflyaccess::urps_count(2025, "roster_snapshot", "national", include_urology = TRUE).
