...
> [`dev/archive/URPS_CONTAINMENT_AND_BASELINE_NOTES.md`](dev/archive/URPS_CONTAINMENT_AND_BASELINE_NOTES.md) (archived: the 1,295-vs-1,339 decision it poses was resolved to 1,306).
...
See [`dev/archive/URPS_CONTAINMENT_AND_BASELINE_NOTES.md`](dev/archive/URPS_CONTAINMENT_AND_BASELINE_NOTES.md) (archived: the 1,295-vs-1,339 decision it poses was resolved to 1,306)
